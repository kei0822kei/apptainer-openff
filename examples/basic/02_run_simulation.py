...
with open("minimized_structure.pdb", "w") as f:
    app.PDBFile.writeFile(simulation.topology, minimized_positions, f)
logger.info("Minimized structure saved as 'minimized_structure.pdb'")

simulation.context.setVelocitiesToTemperature(300 * unit.kelvin)
simulation.reporters.append(app.DCDReporter("production.dcd", 10))
